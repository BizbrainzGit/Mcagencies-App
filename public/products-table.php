                        ...
                        <table id='products_table' class="table table-hover" data-toggle="table" data-url="api-firebase/get-bootstrap-table-data.php?table=products" data-page-list="[5, 10, 20, 50, 100, 200]" data-show-refresh="true" data-show-columns="false" data-side-pagination="server" data-pagination="true" data-search="true" data-trim-on-search="false" data-filter-control="true" data-query-params="queryParams" data-sort-name="id" data-sort-order="desc" data-show-export="true" data-export-types='["txt","excel"]' data-export-options='{
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="is_approved" data-sortable="true" data-visible="false">Is Approved?</th>
                                    ...
                                    <th data-field="return_status" data-sortable="true" data-visible="false">Return</th>
                                    <th data-field="cancelable_status" data-sortable="true" data-visible="false">Cancellation</th>
                                    <th data-field="till_status" data-sortable="true" data-visible="false">Till Status</th>
